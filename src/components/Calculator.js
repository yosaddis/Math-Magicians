...
function Calculator() {
  return (
    <div className="main-container">
      ...
      <button type="button" className="btn-ops btn-equal">=</button>
      <button type="button" className="btn-light btn-clear">AC</button>
      <button type="button" className="btn-light btn-toogle-sign">+/-</button>
      <button type="button" className="btn-light btn-percentage">%</button>
      <button type="button" className="btn-ops btn-divider">/</button>
      <button type="button" className="btn-ops btn-multiply">*</button>
      <button type="button" className="btn-ops btn-substract">-</button>
      <button type="button" className="btn-ops btn-plus">+</button>
